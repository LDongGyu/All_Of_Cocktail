...
public class CockWhatActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private Button cock_def_btn;
    private Button cock_category_btn;
    private Button cock_history;
    private Button cock_character_btn;
    private Button cock_job_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cock_def_btn = (Button)findViewById(R.id.cock_definition);
        cock_category_btn = (Button)findViewById(R.id.cock_category);
        cock_history = (Button)findViewById(R.id.cock_history);
        cock_character_btn = (Button)findViewById(R.id.cock_character);
        cock_job_btn = (Button)findViewById(R.id.cock_job);

        intent = new Intent(getApplicationContext(),CockWhatDetailActivity.class);

        cock_def_btn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        cock_category_btn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                intent.putExtra("category","칵테일의 분류");
                startActivity(intent);
        ...
        cock_history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intent.putExtra("category","칵테일의 역사");
                startActivity(intent);
        ...
        cock_character_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intent.putExtra("category","칵테일의 어원");
                startActivity(intent);
        ...
        cock_job_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intent.putExtra("category","칵테일을 직업으로?");
                startActivity(intent);
